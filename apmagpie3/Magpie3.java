...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (statement.contains("Chen"))
		{
        ...
        else if(statement.contains("Call Of Duty")
        		|| statement.contains("Xbox")
        		|| statement.contains("Playstation")
        		|| statement.contains("Battlefield"))
        {
        	response = " I like video games too";
        }
        else if(statement.contains("Music")
        		|| statement.contains("EDM")
        		|| statement.contains("Rap")
        		|| statement.contains("Trap"))
        {
        	response = "Wow I didn't know you like " + statement;
        }
        else if(statement.contains("shit")
        		|| statement.contains("stupid"))
        {
        	response = "Ay watch your mouth kid";
        }
		else
		{
